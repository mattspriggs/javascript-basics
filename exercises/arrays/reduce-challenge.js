...
Check out the new Complete Intro to React course and learn to build real-world apps.
Mozilla ads
...
function reducer(accumulator, currentValue, index) {
  ...
  console.log(
    \`accumulator: , currentValue: , index:, returns: \`,
  );
  return returns;
}
...
const result = text
  ...
  .filter(isValidChar) //Ensures it is a valid character
